"""Задание 1.
Реализуйте кодирование строки "по Хаффману". У вас два пути:
1) тема идет тяжело? тогда вы можете, опираясь на пример с урока, сделать свою!
версию алгоритма. Разрешается и приветствуется изменение имен переменных, выбор
других коллекций, различные изменения и оптимизации.
2) тема понятна? постарайтесь сделать свою реализацию. Вы можете реализовать
задачу, например, через ООП или предложить иной подход к решению."""

"""Вариант 1. Хаффман через коллекции"""

from collections import Counter, deque


def haffman_tree(str_in):
    # Считаем частоты уникальных символов.
    # Counter({'e': 4, 'b': 3, 'p': 2, ' ': 2, 'o': 2, 'r': 1, '!': 1})
    count = Counter(str_in)
    print(f'{count=}')
    print(f'{count.items()=}')
    print(f'{sorted(count.items(), key=lambda item: item[1])=}')
    # Сортируем по возрастанию количества повторений.
    # deque([('r', 1), ('!', 1), ('p', 2), (' ', 2), ('o', 2), ('b', 3),
    # ('e', 4)])
    # deque([({0: 'r', 1: '!'}, 2), ('p', 2), (' ', 2), ('o', 2), ('b', 3),
    # ('e', 4)])
    ...
    if len(sorted_elements) != 1:
        ...
        while len(sorted_elements) > 1:
            ...
            '''
            deque([({0: 'r', 1: '!'}, 2), ('p', 2), (' ', 2), ('o', 2), 
            ('b', 3), ('e', 4)])
            deque([(' ', 2), ('o', 2), ('b', 3), ({0: {0: 'r', 1: '!'}, 
            1: 'p'}, 4), ('e', 4)])
            deque([('b', 3), ({0: ' ', 1: 'o'}, 4), ({0: {0: 'r', 1: '!'}, 
            1: 'p'}, 4), ('e', 4)])
            deque([({0: {0: 'r', 1: '!'}, 1: 'p'}, 4), ('e', 4), 
            ({0: 'b', 1: {0: ' ', 1: 'o'}}, 7)])
            deque([({0: 'b', 1: {0: ' ', 1: 'o'}}, 7), 
            ({0: {0: {0: 'r', 1: '!'}, 1: 'p'}, 1: 'e'}, 8)])
            deque([({0: {0: 'b', 1: {0: ' ', 1: 'o'}}, 
            1: {0: {0: {0: 'r', 1: '!'}, 1: 'p'}, 1: 'e'}}, 15)])
            '''
    else:
        ...
        sorted_elements.append((comb, weight))
    # sorted_elements - deque([({0: {0: 'b', 1: {0: ' ', 1: 'o'}},
    # 1: {0: {0: {0: 'r', 1: '!'}, 1: 'p'}, 1: 'e'}}, 15)])
    # {0: {0: 'b', 1: {0: ' ', 1: 'o'}},
    #  1: {0: {0: {0: 'r', 1: '!'}, 1: 'p'}, 1: 'e'}}
    # словарь - дерево
...
# {'b': '00', ' ': '010', 'o': '011', 'r': '1000', '!': '1001', 'p': '101',
# 'e': '11'}
haffman_code(haffman_tree(s))

# code_table - {'b': '00', ' ': '010', 'o': '011', 'r': '1000', '!': '1001',
# 'p': '101', 'e': '11'}
