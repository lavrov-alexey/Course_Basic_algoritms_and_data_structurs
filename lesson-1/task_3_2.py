...
"""!!! Невнимательное прочтение ТЗ привело к лишней работе - начал решать задачу
реализации хранилища на разных структурах данных, вместо одной реализации структуры
и опробывания разных методов поиска максимума нескольких элементов !!!"""
